...
// src/utils/rename.ts
var import_lodash, rename;
var init_rename = __esm({
  "src/utils/rename.ts"() {
    "use strict";
    import_lodash = __toESM(require_lodash2());
    rename = (name) => {
      const text = import_lodash.default.camelCase(name);
      return text;
    };
  }
});

// src/svgAssetExport/main.ts
var main_exports = {};
...
function main_default() {
  ...
  figma.on("selectionchange", async function() {
    ...
    if (current.length === 1) {
      ...
      emit("FULL_SCAN", result, duplicate, unsupportedKeys, id);
    }
  });
  showUI({
    height: 200,
...
var childrenScan, PromiseOpen, toSvg;
var init_main = __esm({
  "src/svgAssetExport/main.ts"() {
    "use strict";
    init_lib();
...
// <stdin>
var modules = { "src/svgAssetExport/main.ts--default": (init_main(), __toCommonJS(main_exports))["default"] };
var commandId = true ? "src/svgAssetExport/main.ts--default" : figma.command;
modules[commandId]();
