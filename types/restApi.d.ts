...
export interface components {
  schemas: {
    ...
    TypePropertiesTrait: {
      ...
      /** @description Array with same number of elements as characters in text rendered using this style. Each element is a reference to the `styleOverrideTable` and maps to the corresponding character in the characters field. Elements with value 0 have the default type style. */
    ...
    /**
     * @description Scopes allow a variable to be shown/hidden in the variable picker UI for various fields. This declutters the Figma UI if you have a large number of variables. Currently only supported on `FLOAT` and `COLOR` variables.
     *
     ...
     * @enum {string}
     */
    VariableScope: "ALL_SCOPES" | "TEXT_CONTENT" | "CORNER_RADIUS" | "WIDTH_HEIGHT" | "GAP" | "ALL_FILLS" | "FRAME_FILL" | "SHAPE_FILL" | "TEXT_FILL" | "STROKE_COLOR" | "STROKE_FLOAT" | "EFFECT_FLOAT" | "EFFECT_COLOR" | "OPACITY";
